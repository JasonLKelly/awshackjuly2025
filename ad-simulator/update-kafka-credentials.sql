...
DROP VIEW IF EXISTS impressions_mv;
DROP TABLE IF EXISTS impressions_kafka;

-- Kafka consumer with updated credentials
...
SETTINGS
    ...
    kafka_group_name = 'clickhouse_updated_creds',
